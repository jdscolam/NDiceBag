...
namespace NDiceBag
{
	public class Dice
	{
		...
		public Dice DivideRoundingDown(int modifier)
		{
			RollModifiers.Add(roll => roll / modifier);
		...
		public Dice DivideRoundingUp(int modifier)
		{
			RollModifiers.Add(roll => roll % modifier == 0 ? roll / modifier : (roll / modifier) + 1);
